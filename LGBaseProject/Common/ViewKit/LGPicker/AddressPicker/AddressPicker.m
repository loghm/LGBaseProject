...
- (void)setBaseView {
    ...
    [self.cancelButton setTitleColor:[UIColor blueColor] forState:0];
    self.cancelButton.frame = CGRectMake(0, 0, 60, 40);
    [self.cancelButton addTarget:self action:@selector(dateCancleAction) forControlEvents:UIControlEventTouchUpInside];
    [selectView addSubview:self.cancelButton];
    
    self.ensureButton = [UIButton buttonWithType:UIButtonTypeCustom];
    [self.ensureButton setTitle:@"确定" forState:0];
    [self.ensureButton setTitleColor:[UIColor blueColor] forState:0];
    self.ensureButton.frame = CGRectMake(width - 60, 0, 60, 40);
    [self.ensureButton addTarget:self action:@selector(dateEnsureAction) forControlEvents:UIControlEventTouchUpInside];
    [selectView addSubview:self.ensureButton];
...
- (void)setFontColor:(UIColor *)fontColor {
    ...
    [self.cancelButton setTitleColor:_fontColor forState:UIControlStateNormal];
    [self.ensureButton setTitleColor:_fontColor forState:UIControlStateNormal];
