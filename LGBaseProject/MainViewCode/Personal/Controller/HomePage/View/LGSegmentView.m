...
@interface LGSegmentView()<UIScrollViewDelegate>

@property (nonatomic, strong) LGSegmentHeaderView *headerView;
...
- (instancetype)initWithFrame:(CGRect)frame controllers:(NSArray *)controllers titleArray:(NSArray *)titleArray parentController:(UIViewController *)parentController {
    if ( self = [super initWithFrame:frame]) {
        ...
        self.headerView = [[LGSegmentHeaderView alloc] initWithFrame:CGRectMake(0, 0, kWidth, SegmentHeaderViewHeight) titleArray:titleArray];
